...
# Connect to the Luckycoin node
try:
    rpc_connection = AuthServiceProxy(RPC_URL, timeout=120)
    # Test the connection
    block_count = rpc_connection.getblockcount()
    print(f"Successfully connected to the Luckycoin node. Current block height: {block_count}")
except Exception as e:
    print(f"Error connecting to the Luckycoin node: {e}")
    print("Please check your RPC credentials and ensure the Luckycoin node is running and fully synced.")
    sys.exit(1)
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                print("This could be due to the transaction not being in the blockchain or pruned data.")
                print("Ensure that txindex=1 is set in your Luckycoin configuration file.")
                break
        ...
        print("This could be due to RPC connection issues or invalid transaction IDs.")
    except Exception as e:
